  ...
  <header class="container-fluid p-0 fixed-top shadow">
    <nav class="navbar navbar-expand-lg navbar-light">
      <a class="navbar-brand logo" href="<?= get_home_url() ?>">
        ...
        <p class="font-italic logo__slogan">Le monde se divise en 2
        </p>
      </a>
      <!-- toggle button -->
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        ...
        <div class="dropdown mr-3">
          <button class="btn btn btn-outline-dark 
            ...
            type="button" id="categories" data-toggle="dropdown" 
            ...
            <div class="dropdown-menu" aria-labelledby="categories">
              ...
              <a href="<?= get_page_link(88);?>">
                <button class="dropdown-item text-success font-weight-bold">
                Favoris
                </button>
              </a>
                <?php endif; ?>
            ...
            <!-- submit button -->
            <span>
              <a class="btn btn btn-outline-dark btn-submit mr-5 font-weight-bold" 
                href="<?= get_page_link(70); ?>" role="button">
                <span>
                Ta citation
                </span>
              </a>
            ...
            <form class="form-inline my-2 my-lg-0 mr-5" method="get">
              <input class="form-control mr-sm-2 d-none d-sm-block" value=
            ...
            <div class="dropdown">
              <button class="btn btn btn-outline-dark dropdown-toggle font-weight-bold"
